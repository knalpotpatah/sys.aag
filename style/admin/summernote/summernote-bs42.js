 ...
 * https://summernote2.org
 *
 * Copyright 2013- Alan Hong. and other contributors
 * summernote2 may be freely distributed under the MIT license.
 *
...
(function (global, factory) {
  ...
  $$1.summernote2 = $$1.summernote2 || {
      lang: {}
  };
  $$1.extend($$1.summernote2.lang, {
      'en-US': {
          font: {
              bold: 'Bold',
              italic: 'Italic',
  ...
  var Context = /** @class */ (function () {
      ...
      Context.prototype.destroy = function () {
          this._destroy();
          this.$note.removeData('summernote2');
      ...
      Context.prototype._initialize = function () {
          ...
          var modules = $$1.extend({}, this.options.modules, $$1.summernote2.plugins || {});
      ...
      Context.prototype.triggerEvent = function () {
          ...
          this.$note.trigger('summernote2.' + namespace, args);
      };
  ...
  $$1.fn.extend({
       ...
       * @return {this}
       */
      summernote2: function () {
          var type = $$1.type(lists.head(arguments));
          var isExternalAPICalled = type === 'string';
          var hasInitOptions = type === 'object';
          var options = $$1.extend({}, $$1.summernote2.options, hasInitOptions ? lists.head(arguments) : {});
          // Update options
          options.langInfo = $$1.extend(true, {}, $$1.summernote2.lang['en-US'], $$1.summernote2.lang[options.lang]);
          options.icons = $$1.extend(true, {}, $$1.summernote2.options.icons, options.icons);
          options.tooltip = options.tooltip === 'auto' ? !env.isSupportTouch : options.tooltip;
          this.each(function (idx, note) {
              var $note = $$1(note);
              if (!$note.data('summernote2')) {
                  var context = new Context($note, options);
                  $note.data('summernote2', context);
                  $note.data('summernote2').triggerEvent('init', context.layoutInfo);
              }
          });
          var $note = this.first();
          if ($note.length) {
              var context = $note.data('summernote2');
  ...
  */
  ...
  var Handle = /** @class */ (function () {
      function Handle(context) {
          ...
          this.lang = this.options.langInfo;
          this.events = {
              'summernote2.mousedown': function (we, e) {
                  if (_this.update(e.target, e)) {
                      e.preventDefault();
                  }
              },
              'summernote2.keyup summernote2.scroll summernote2.change summernote2.dialog.shown': function () {
                  _this.update();
              },
              'summernote2.disable': function () {
                  _this.hide();
              },
              'summernote2.codeview.toggled': function () {
                  _this.update();
              }
          };
      }
  ...
  var AutoLink = /** @class */ (function () {
      function AutoLink(context) {
          ...
          this.context = context;
          this.events = {
              'summernote2.keyup': function (we, e) {
                  if (!e.isDefaultPrevented()) {
                      _this.handleKeyup(e);
                  }
              },
              'summernote2.keydown': function (we, e) {
  ...
  var Placeholder = /** @class */ (function () {
      function Placeholder(context) {
          ...
          this.options = context.options;
          this.events = {
              'summernote2.init summernote2.change': function () {
                  _this.update();
              },
              'summernote2.codeview.toggled': function () {
                  _this.update();
  ...
  var Toolbar = /** @class */ (function () {
      ...
      Toolbar.prototype.initialize = function () {
          ...
          this.$note.on('summernote2.keyup summernote2.mouseup summernote2.change', function () {
  ...
  var LinkPopover = /** @class */ (function () {
      function LinkPopover(context) {
          ...
          this.options = context.options;
          this.events = {
              'summernote2.keyup summernote2.mouseup summernote2.change summernote2.scroll': function () {
                  _this.update();
              },
              'summernote2.disable summernote2.dialog.shown': function () {
                  _this.hide();
              }
          };
      }
  ...
  var TablePopover = /** @class */ (function () {
      function TablePopover(context) {
          ...
          this.events = {
              ...
              'summernote2.keyup summernote2.scroll summernote2.change': function () {
                  _this.update();
              },
              'summernote2.disable': function () {
                  _this.hide();
  ...
  var HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.initialize = function () {
          ...
          var body = [
              '<p class="text-center">',
              '<a href="http://summernote2.org/" target="_blank">summernote2 0.8.12</a> · ',
              '<a href="https://github.com/summernote2/summernote2" target="_blank">Project</a> · ',
              '<a href="https://github.com/summernote2/summernote2/issues" target="_blank">Issues</a>',
              '</p>',
          ].join('');
          this.$dialog = this.ui.dialog({
  ...
  var AirPopover = /** @class */ (function () {
      function AirPopover(context) {
          ...
          this.options = context.options;
          this.events = {
              'summernote2.keyup summernote2.mouseup summernote2.scroll': function () {
                  _this.update();
              },
              'summernote2.disable summernote2.change summernote2.dialog.shown': function () {
                  _this.hide();
              },
              'summernote2.focusout': function (we, e) {
  ...
  $$1.summernote2 = $$1.extend($$1.summernote2, {
      version: '0.8.12',
      plugins: {},
      dom: dom,
      range: range,
      options: {
          langInfo: $$1.summernote2.lang['en-US'],
          modules: {
              'editor': Editor,
              'clipboard': Clipboard,
              'dropzone': Dropzone,
  ...
  $$1.summernote2.options.styleTags = [
      'p',
...
//# sourceMappingURL=summernote2-bs4.js.map
