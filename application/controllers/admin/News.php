...
class news extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('back/admin/news/index', $data);
    }
  public function tambah()
    {
        $this->load->view('back/admin/news/tambah_news');
    ...
    {
        $data['news'] = $this->db->get_where('news', ['id' => $id])->row();
        $this->load->view('back/admin/news/edit_news', $data);
        if ($this->input->post('submit')) {
            // if (!empty($_FILES['img']['name'])) {
            ...
            // } else {
                ...
                $tambah = $this->db->update('news', $data);
                if ($tambah) {
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> <strong>news berhasil diubah.</strong> </div>');
                    redirect(base_url('admin/news'));
                }
            // }
        }
