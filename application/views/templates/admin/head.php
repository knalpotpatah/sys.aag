...
<head>
  ...
  <title>PT AAG Pest Control</title>
  <!-- Tell the browser to be responsive to screen width -->
  <!-- <link rel="stylesheet" href="<?= base_url('assets/') ?>bower_components/materialize/css/materialize.min.css"> -->
  ...
  <link rel="stylesheet" href="<?= base_url('assets/') ?>ckeditor/ckeditor.js">
  <!-- <link rel="stylesheet" href="<?= base_url('assets/backend/') ?>summernote/bs3/summernote-lite-bs3.min.css"> -->
