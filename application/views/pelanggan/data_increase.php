            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data Pelanggan Increase</h3>
                        ...
                        <table id="example1" class="display table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Total Kontrak</th>
                                    <th>Increase</th>
                                    <th>Nilai Increase</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($data_inc as $h) : ?>
                                    <?php 
                                    ...
                                    <tr>
                                        ...
                                        <?php if($h->increase == null ) :?>
                                        <td>0</td>
                                        <td>0</td>
                                        <?php else : ?>
                                        <?php  $hasil = ($total + $h->increase); ?>    
                                        <td>Rp.<?= number_format($h->increase) ?>,-</td>
