            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data Pelanggan Kontrak</h3>
                            ...
                            <tbody>
                                <?php foreach ($kontrak as $h) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/images/edit/') . $h->id ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pen"></i></a>
